...
export default {
  ...
  methods:{
    fnGetThisCategory(){
      ...
      .then(dat=>{
         this.SpuForm.name = dat.data[0].name;
         this.SpuForm.brand_id = dat.data[0].brand_id;
         this.SpuForm.category1_id = dat.data[0].category1_id;
         this.fnGetCategory_sub(dat.data[0].category1_id,2);
         this.SpuForm.category2_id = dat.data[0].category2_id;
         this.fnGetCategory_sub(dat.data[0].category2_id,3);
         this.SpuForm.category3_id = dat.data[0].category3_id;
         this.SpuForm.desc_detail = dat.data[0].desc_detail;
         this.SpuForm.desc_pack = dat.data[0].desc_pack;
         this.SpuForm.desc_service = dat.data[0].desc_service;
      }).catch(err=>{
         console.log(err);
      });
    },
    ...
    fnGetCategory_sub:function(sid,num){
      this.axios.get(cons.apis + '/goods/categories/' + sid +'/', {
          headers: {
            'Authorization': 'JWT ' + token
          },
          responseType: 'json'
