    ...
    methods: {
        ...
        check_tel: function () {
            ...
            if (re.test(this.mobile)) {
                ...
                this.error_tel_message = '您输入的手机号格式不正确';
                this.error_tel = true;
            }
            if (this.error_tel == false) {
        ...
        send_sms_code: function () {
            ...
            if (this.error_tel == true || this.error_image_code == true) {
        ...
        on_submit(){
            ...
            if (this.error_name == true || this.error_password == true || this.error_check_password == true
                || this.error_tel == true || this.error_sms_code == true || this.error_allow == true) {
                // 不满足注册条件：禁用表单
